 ...
 This version support the sending of appoximate altitude but  note you have to set the local sea level pressure, Catenne not in this version
*/
...
static void PrepareTxFrame( uint8_t port )
{
 ...
 if(!bme280.init()){
  ...
  float altitude = (bme280.calcAltitude(pressure*100)); // aproximate altitude  Note must set local  Sea level pressure   
